...
@section('title')
    <a class="navbar-brand" href="#">Tahap Preprocessing</a>
@endsection
@section('content')
    <div class="col-lg-3">
        <div class="contact-box center-version">

            <a href="{{url(action('AgusController@data'))}}">
    ...
    <div class="col-lg-3">
        <div class="contact-box center-version">
            ...
            <a href="{{url(action('AhokController@data'))}}">
    ...
    <div class="col-lg-3">
        <div class="contact-box center-version">
            ...
            <a href="{{url(action('AnisController@data'))}}">
